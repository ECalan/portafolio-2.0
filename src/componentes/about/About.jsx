...
<section className="title">
        <div className="title__div">
            ...
            <div className="title__container">
                ...
                <h3 className="title__subsection title__biography">Soy orgullosamente Guatemalteco, tengo 33 años de edad, formado en Bachillerato en Computación con Orientación Comercial y actualmente estoy participando del proyecto Oracle ONE en Alura Latam.</h3>
